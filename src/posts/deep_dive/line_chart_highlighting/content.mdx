...
## 목표
![before mouse hover](./1.webp)

![when hovering mouse](./2.webp)
...
![before mouse hover](./3.webp)![when hovering mouse3](./4.webp)
...
![출처 : https://stackoverflow.com/questions/42585861/chart-js-increase-spacing-between-legend-and-chart](./5.webp)
...
![내 생각과 연관된 chart.js github issue](./9.webp)
...
![hover 후 빠르게 chart에서 마우스 leave 했을 때 강조가 남아있는 현상](./8.webp)
