...
## 목표
![before mouse hover](./1.png)

![when hovering mouse](./2.png)
...
![before mouse hover](./3.jpeg)![when hovering mouse3](./4.jpeg)
...
![출처 : https://stackoverflow.com/questions/42585861/chart-js-increase-spacing-between-legend-and-chart](./5.png)
...
![내 생각과 연관된 chart.js github issue](./9.jpg)
...
![hover 후 빠르게 chart에서 마우스 leave 했을 때 강조가 남아있는 현상](./8.jpeg)
